  ...
  <div class="flex flex-col h-screen w-800 mx-auto">
    ...
    <div class="flex flex-row justify-between items-center mt-20 mb-4">
      ...
      <div class="flex flex-row space-x-4 items-center">
        <!--SEARCH INPUT-->
        <div v-if="isSearch" id="searchContainer"
          ...
          <XIcon @click="closeInput()" class="w-5 h-5 stroke-primary-grey hover:cursor-pointer"/>
        </div>

        <SearchIcon @click="isSearch=true;" class="w-5 h-5 hover:cursor-pointer" :class="isSearch ? 'stroke-primary-orange' : ''"/>
